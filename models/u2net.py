...
class U2Net(nn.Module):
    def __init__(self, n_channels, n_classes=2):  # backbone=None, output_stride=16, num_classes=2, sync_bn=False, freeze_bn=False
        super(U2Net, self).__init__()
        self.freeze_bn = False
        self.inc = in_conv(n_channels, 64)  # 维度
